...
See [Adding a Skill](/contributing/adding-a-skill) for details.
...
- Follow the [conventions](/contributing/conventions)
- Test your changes (run the relevant skill against a test repo)
- Keep PRs focused --- don't bundle unrelated changes

## Code of Conduct

We follow the [Contributor Covenant](https://github.com/Atypical-Consulting/GitHubSkills/blob/main/CODE_OF_CONDUCT.md). Be kind and constructive.
